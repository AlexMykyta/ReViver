  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground md:text-xl">
                  A nossa plataforma conecta doadores a pessoas que precisam de comida, roupas e artigos para casa. Faça
                  a diferença na nossa comunidade hoje.
                </p>
                <div className="flex flex-col gap-2 sm:flex-row">
                  <Link href="/donations">
                    <Button size="lg" className="btn-primary-custom w-full sm:w-auto">
                      Ver doações
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
                  </Link>
                  <Link href="/donations/new">
                    <Button variant="outline" size="lg" className="btn-secondary-custom w-full sm:w-auto">
                      Doar
                    </Button>
                  </Link>
                </div>
              ...
              <div className="flex justify-center">
                <div className="relative w-full max-w-md aspect-video overflow-hidden rounded-xl">
                  <Image
                    src="/images/donation-sharing.jpg"
                    alt="Pessoas compartilhando doações de alimentos e roupas"
                    width={600}
                    height={400}
        ...
        <section className="section-alt w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <p className="opacity-90">Doe alimentos não perecíveis para famílias necessitadas.</p>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <p className="opacity-90">Doe roupas em bom estado que você não usa mais com quem precisa.</p>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-full icon-muted text-white">
        ...
        <section className="volunteer-section w-full py-12 md:py-24">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Torne-se um Voluntário</h2>
                <p className="max-w-[900px] text-[hsl(var(--color-lavender))] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            ...
            <div className="mx-auto max-w-3xl bg-background rounded-lg shadow-lg overflow-hidden">
              <div className="grid md:grid-cols-2">
                <div className="p-8 flex flex-col justify-center">
                  <h3 className="text-2xl font-bold mb-4 text-foreground">Junte-se à Nossa Equipe</h3>
                  ...
                  <Link href="/volunteers">
                    <Button className="btn-primary-custom w-full sm:w-auto">
                ...
                <div className="bg-muted">
                  <Image
                    ...
                    alt="Voluntários trabalhando juntos organizando doações"
                    width={400}
                    height={300}
                    className="object-cover w-full h-full"
                  />
